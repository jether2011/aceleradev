...
public class TesteTime {
	...
	public static void main(String[] args) {
		...
		List<Jogador> jogadoresSPFC = Arrays.asList(
				new Jogador.Builder()
					.usandoNome("Jether")
					.naPosicao(Posicao.ATACANTE)
					.daCidade("Lorena")
					.doPais("Brasil").build().adicionarGoal(5),
				new Jogador.Builder()
					.usandoNome("Denise")
					.naPosicao(Posicao.ZAGUEIRO)
					.daCidade("São José dos Campos")
					.doPais("Brasil").build(),
				new Jogador.Builder()
					.usandoNome("Bia")
					.naPosicao(Posicao.GOLEIRO)
					.daCidade("Canas")
					.doPais("Brasil").build(),
				new Jogador.Builder()
					.usandoNome("Isa")
					.naPosicao(Posicao.LATERAL_ESQUERDA)
					.daCidade("Taubaté")
					.doPais("Brasil").build().adicionarGoal(6)
		);
		...
		List<Jogador> jogadoresPFC = Arrays.asList(
				new Jogador.Builder()
					...
					.naPosicao(Posicao.ATACANTE)
					.daCidade("Lorena")
					.doPais("Brasil").build().adicionarGoal(2),
				new Jogador.Builder()
					.usandoNome("Abner")
					.naPosicao(Posicao.ZAGUEIRO)
					.daCidade("São José dos Campos")
				...
				new Jogador.Builder()
					...
					.naPosicao(Posicao.GOLEIRO)
					.daCidade("Canas")
					.doPais("Brasil").build().adicionarGoal(1),
				new Jogador.Builder()
					.usandoNome("Ana Mel")
					.naPosicao(Posicao.LATERAL_ESQUERDA)
					.daCidade("Taubaté")
